    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-white/40 mt-2 text-sm">Inscription — Entreprise</p>
        </div>
        <div className="bg-[#141517] border border-white/5 rounded-[2rem] p-8 space-y-5">
          {['Dénomination sociale', 'Secteur d\'activité', 'Chiffre d\'affaires annuel (FCFA)', 'Email professionnel', 'Téléphone', 'Mot de passe'].map((label) => (
            <div key={label}>
          ...
          <Link to="/professionnel/tableau-de-bord"
            ...
            Créer mon espace entreprise <ArrowRight className="w-4 h-4" />
          </Link>
        </div>
      </div>
    </div>
