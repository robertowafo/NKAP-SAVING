...
import { Play, ArrowRight, ArrowUpRight, CheckCircle2, ChevronRight, TrendingUp, Building2, Coins, BarChart3, Briefcase, Users } from 'lucide-react';
...
const TESTIMONIALS = [
  {
    quote: "Ils ont fourni une stratégie complète qui a immédiatement focalisé toute notre équipe. La différence d'engagement s'est remarquée dès le premier mois.",
    name: "Edward Hayes",
  ...
  {
    quote: "Nos précédentes campagnes ressemblaient à jeter des spaghettis sur un mur. L'équipe a apporté une structure claire et data-driven.",
    name: "Alistair Finch",
    role: "CEO de PME",
    theme: "light-purple",
    qColor: "text-[#5b58f6]"
  ...
  {
    quote: "Les concepts innovants qu'ils ont développés étaient frais, engageants et parfaitement ciblés. La meilleure plateforme institutionnelle de la région CEMAC.",
    name: "James Cornell",
  ...
  {
    quote: "L'aspect le plus précieux de notre travail avec eux est leur communication proactive. On ne s'est jamais senti comme un simple client distant.",
    name: "Luna Fox",
    ...
    <div className="flex flex-col w-full overflow-x-clip bg-[#0a0a0a]">
      ...
      <section className="relative px-4 sm:px-6 lg:px-8 pt-32 pb-24 md:pt-40 md:pb-32 bg-[#0a0a0a] text-white">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            >
              <span className="bg-white text-[#0a0a0a] px-2 py-0.5 rounded-full text-xs mr-1 uppercase tracking-wider">Nouveau</span>
            ...
            <motion.h1
              ...
              className="font-display font-medium text-5xl md:text-7xl lg:text-[6.5rem] tracking-tighter leading-[1.05] max-w-5xl mb-8"
            >
              Propulsez la <br className="hidden md:block"/>
              Nouvelle Génération <br className="hidden md:block"/>
              <span className="text-gray-400">de la Finance</span>
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-lg md:text-xl text-white/50 max-w-2xl font-medium mb-10"
            >
              Connectez épargnants, entreprises et institutions avec des stratégies basées sur les données, une transparence totale et une croissance continue en zone CEMAC.
            </motion.p>
            ...
            >
              <Link to="/inscription" className="w-full sm:w-auto px-8 py-4 bg-brand-neon text-[#0a0a0a] font-bold rounded-full hover:bg-white transition-all text-base flex items-center justify-center gap-2">
          ...
          >
            ...
            <div className="md:col-span-4 bg-[#141517] rounded-3xl p-6 border border-white/5 flex flex-col justify-end bg-cover bg-center overflow-hidden relative min-h-[280px]">
              ...
              <img src="https://images.unsplash.com/photo-1573164713988-8665fc963095?auto=format&fit=crop&q=80&w=600" alt="Team" className="absolute inset-0 w-full h-full object-cover mix-blend-overlay opacity-40" />
              <div className="relative z-10">
                 ...
                 <p className="text-white/50 text-sm mt-1">Nos partenaires et clients vérifiés</p>
              </div>
            </div>
            ...
            <div className="md:col-span-4 grid grid-rows-2 gap-4 min-h-[280px]">
               <div className="bg-[#141517] rounded-3xl p-6 border border-white/5 flex items-center justify-between">
                  <div>
                    <h3 className="font-display font-medium text-2xl mb-1">Croissance<br/>Transparente</h3>
                  </div>
               ...
               <div className="bg-[#141517] rounded-3xl p-6 border border-white/5 flex items-center justify-between relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <h3 className="font-display font-medium text-2xl mb-1">Sécurité<br/>Renforcée</h3>
                  </div>
            ...
            <div className="md:col-span-4 bg-[#141517] rounded-3xl p-6 border border-white/5 relative min-h-[280px] overflow-hidden">
               ...
               <h3 className="font-display font-medium text-5xl mb-4 relative z-10">20+</h3>
               <p className="text-white/50 text-md pr-12 leading-snug mb-6 relative z-10">Institutions Financières de premier plan de la zone CEMAC.</p>
               <div className="flex gap-2 relative z-10">
                  <span className="px-4 py-1.5 bg-brand-neon text-[#0a0a0a] rounded-full text-xs font-bold">Gabon</span>
                  <span className="px-4 py-1.5 bg-white/10 text-white rounded-full text-xs font-bold">Cameroun</span>
               </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 items-start mb-16">
            <div className="lg:w-1/4">
               <span className="text-sm font-bold text-gray-500 tracking-widest uppercase">À propos de NKAP</span>
            </div>
            <div ref={textRef} className="lg:w-3/4 flex flex-wrap font-display font-medium text-3xl md:text-5xl leading-tight tracking-tight">
              {textWords.map((word, i) => {
                const start = i / textWords.length;
                const end = start + (1 / textWords.length);
                const color = useTransform(textProgress, [start, end], ["#9ca3af", "#0a0a0a"]);
                return (
                  <motion.span key={i} style={{ color }} className="mr-2 md:mr-3 mb-2">
                    {word}
                  </motion.span>
                );
              })}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 h-[400px]">
            <div className="w-full h-full rounded-3xl overflow-hidden relative group">
              <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&q=80&w=1200" alt="Team meeting" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
            </div>
            <div className="w-full h-full rounded-3xl overflow-hidden relative group bg-[#dfdeda] flex items-center justify-center p-8">
               <div className="text-center">
                 <h3 className="font-display font-medium text-4xl text-brand-dark mb-4">Des penseurs<br/>audacieux et brillants</h3>
                 <Link to="/decouvrir" className="inline-flex items-center gap-2 px-6 py-3 bg-brand-neon text-brand-dark rounded-full font-bold text-sm hover:bg-[#0a0a0a] hover:text-white transition-colors">
            ...
            {OFFERS.map((offer, i) => (
               ...
               >
                  <div className="flex justify-between items-start">
                     <h3 className="font-display font-medium text-4xl md:text-5xl lg:text-7xl text-brand-dark tracking-tight max-w-2xl">{offer.title}</h3>
                     <span className="font-display font-medium text-4xl md:text-6xl text-brand-dark">{offer.num}</span>
                  </div>
                  ...
                  <div className="flex flex-col-reverse md:flex-row justify-between items-end gap-12 mt-12 md:mt-auto relative z-10 h-full md:h-auto pb-8 md:pb-0">
                     <div className="max-w-md w-full flex flex-col justify-end bg-brand-gray/50 md:bg-transparent backdrop-blur-xl md:backdrop-blur-none p-6 md:p-0 rounded-3xl md:rounded-none">
                        <h4 className="text-xl md:text-2xl font-bold text-brand-dark mb-4 leading-tight">{offer.subtitle}</h4>
                        <p className="text-brand-dark/80 font-medium text-sm md:text-base mb-6">
                          {offer.desc}
                        </p>
                        <Link to="/decouvrir" className="inline-flex items-center gap-3 bg-[#111] text-white pl-2 pr-6 py-2 rounded-full font-medium hover:bg-black transition-transform hover:scale-105 w-max group">
                     ...
                     <div className="absolute right-0 bottom-0 md:relative w-[70%] md:w-[45%] h-[60%] md:h-[350px] -z-10 md:z-0 rounded-tl-3xl md:rounded-3xl overflow-hidden opacity-50 md:opacity-100 mix-blend-multiply md:mix-blend-normal">
                        <div className="w-full h-full bg-black/5 relative p-6 flex items-center justify-center">
                           {i === 0 && (
                              <div className="relative w-full h-full">
                                 <div className="absolute bottom-10 left-1/2 -translate-x-1/2 w-16 h-32 bg-[#2a5d4a] rounded-sm"></div>
                                 <div className="absolute bottom-16 left-1/2 ml-8 w-12 h-12 bg-[#dfc6a3] rounded-full"></div>
                                 <div className="absolute bottom-40 left-1/2 -translate-x-1/2 w-20 h-20 bg-[#d8d8d8] rounded-sm flex items-center justify-center">
                                    <div className="w-8 h-8 bg-[#111] rounded-sm"></div>
                                 </div>
                              </div>
                           )}
                           {i === 1 && (
                              <div className="relative w-full h-full">
                                 <div className="absolute top-10 left-10 w-24 h-24 bg-[#ffedfc] rounded-xl rotate-12 shadow-sm"></div>
                                 <div className="absolute bottom-10 right-10 w-28 h-28 bg-[#d69cac] rounded-xl -rotate-6 shadow-sm"></div>
                                 <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 bg-white rounded-full"></div>
                              </div>
                           )}
                           {i === 2 && (
                              <div className="relative w-full h-full">
                                 <div className="absolute inset-x-10 top-1/4 h-16 bg-white shadow-sm rounded-lg skew-y-6 flex overflow-hidden">
                                    <div className="w-1/3 h-full bg-[#111]"></div>
                                 </div>
                                 <div className="absolute inset-x-20 bottom-1/4 h-16 bg-[#b5c7d8] rounded-full -skew-y-6"></div>
                              </div>
                           )}
                           {i === 3 && (
                              <div className="relative w-full h-full flex items-center justify-center">
                                 <div className="w-48 h-48 border-[12px] border-[#ffd1a3] border-r-transparent rounded-full rotate-45"></div>
                                 <div className="absolute w-24 h-24 bg-[#ffd1a3] rounded-full"></div>
                              </div>
                           )}
                           {i === 4 && (
                              <div className="relative w-full h-full">
                                 <div className="absolute bottom-0 left-0 w-full h-1/2 bg-gradient-to-t from-[#abbaf0] to-transparent"></div>
                                 <div className="absolute top-10 left-1/2 -translate-x-1/2 w-1.5 h-[80%] bg-[#222]"></div>
                                 <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 bg-white rounded-full border-4 border-[#222]"></div>
                              </div>
                           )}
                        </div>
                     </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row gap-8 mb-16 justify-between items-end">
            <h2 className="font-display font-medium text-4xl md:text-6xl max-w-2xl leading-[1.1] tracking-tight text-white mb-4">
              Des solutions taillées <br/> pour votre <span className="text-brand-neon underline decoration-brand-neon decoration-4 underline-offset-8">Croissance</span>
            </h2>
            <Link to="/connexion" className="px-8 py-4 bg-brand-neon text-[#0a0a0a] font-bold rounded-full hover:bg-white transition-colors text-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              { title: 'Épargnant Particulier', desc: 'Investissez dans des fractions d\'actions, des FCP et de l\'immobilier.', icon: BarChart3 },
              { title: 'Entreprise & PME', desc: 'Levez des fonds via le crowdfunding ou trouvez des financements.', icon: Building2 },
              { title: 'Institution Bancaire', desc: 'Accédez à des dossiers qualifiés, proposez vos offres de crédit.', icon: Briefcase },
              { title: 'Asset Manager', desc: 'Distribuez vos FCP directement aux particuliers.', icon: Coins },
            ].map((card, i) => (
              <div key={i} className="bg-[#141517] origin-bottom-left border border-white/5 p-8 rounded-[2rem] flex flex-col justify-between min-h-[360px] group overflow-hidden relative cursor-pointer hover:bg-white hover:text-brand-dark transition-all duration-500 hover:-rotate-3 hover:-translate-y-2 hover:-translate-x-2">
                 <div className="relative z-10 flex flex-col h-full justify-between">
                   <card.icon className="w-8 h-8 text-brand-neon group-hover:text-brand-dark transition-colors duration-500 mb-8" />
                   <div>
                     <h3 className="font-display font-medium text-3xl mb-4 group-hover:text-brand-dark transition-colors duration-500 tracking-tight leading-tight">{card.title}</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16">
            <div className="lg:col-span-4 flex flex-col justify-between">
              <h2 className="font-display font-medium text-4xl md:text-5xl leading-tight mb-8">
                Les Chiffres <br/> de la<br/> Réussite
              </h2>
              <Link to="/connexion" className="inline-flex w-fit items-center gap-2 px-6 py-3 border border-white/20 rounded-full font-bold text-sm hover:bg-white hover:text-brand-dark transition-colors">
            ...
            <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
               <div className="bg-brand-neon text-brand-dark p-8 rounded-[2rem] flex flex-col justify-end min-h-[300px]">
                 ...
                 <p className="text-sm font-bold uppercase tracking-widest pl-1">Utilisateurs</p>
               </div>
               <div className="bg-white text-brand-dark p-8 rounded-[2rem] flex flex-col justify-end min-h-[300px]">
                 <h3 className="font-display font-bold text-[4rem] leading-none mb-4 tracking-tighter">
                   <AnimatedCounter end={98} suffix="%" />
                 </h3>
                 <p className="text-sm font-bold uppercase tracking-widest pl-1 text-gray-400">Satisfaction</p>
               </div>
               <div className="bg-[#141517] text-white p-8 rounded-[2rem] flex flex-col justify-end min-h-[300px] border border-white/5">
                 ...
                 <p className="text-sm font-bold uppercase tracking-widest pl-1 text-white/50">Demandes</p>
               </div>
            </div>
          </div>

          <div className="flex flex-wrap gap-4 pt-12 pb-8">
             {['Agence Stratégique', 'Orienté Résultats', 'Innovation Financière', 'Multidimensionnel', 'Orienté Solution', 'Mindset Croissance'].map((pill, i) => (
                <div key={i} className={cn(
                  "px-8 py-4 rounded-full font-bold text-sm",
                  i === 0 ? "bg-white text-[#0a0a0a]" : i === 2 ? "bg-gradient-to-r from-brand-neon to-emerald-400 text-[#0a0a0a]" : "bg-[#141517] text-white border border-white/10"
                )}>
                  {pill}
                </div>
             ))}
      ...
      <section className="bg-brand-gray py-32 rounded-t-[3rem] -mt-16 relative z-30 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-16">
          <h2 className="font-display font-medium text-4xl md:text-5xl text-brand-dark mb-6 tracking-tight">De Vraies Personnes, <br/>De Vrais Retours</h2>
          <p className="text-gray-500 font-medium">Découvrez ce que disent nos utilisateurs de leur expérience.</p>
        </div>
          ...
          <div className="flex w-max animate-scroll-left hover:[animation-play-state:paused] gap-6 px-4">
             {[...TESTIMONIALS, ...TESTIMONIALS].map((testi, i) => (
                <div key={i} className={cn(
                  ...
                  testi.theme === 'dark' ? "bg-[#0a0a0a] text-white" :
                  testi.theme === 'light-purple' ? "bg-[#e4e2fd] text-brand-dark" :
                  testi.theme === 'neon' ? "bg-brand-neon text-brand-dark" :
                  "bg-white border border-black/5 text-brand-dark shadow-sm"
                )}>
                  <div className={cn("text-5xl font-display mb-6 leading-none", testi.qColor)}>"</div>
                  <p className={cn("text-lg font-medium leading-relaxed mb-10 h-[120px] md:h-[100px]", 
                    testi.theme === 'dark' ? "text-white/90" : "text-brand-dark/90"
                  )}>
                    {testi.quote}
                  </p>
                  <div className="flex items-center gap-4">
                     <div className={cn("w-12 h-12 rounded-full shrink-0",
                       testi.theme === 'dark' ? "bg-white/10" :
                       testi.theme === 'light-purple' ? "bg-white/50" :
                       testi.theme === 'neon' ? "bg-white/30" : "bg-gray-100"
                     )}></div>
                     <div>
                       <h4 className="font-bold">{testi.name}</h4>
                       <p className={cn("text-xs",
                         testi.theme === 'dark' ? "text-white/50" :
                         testi.theme === 'neon' ? "text-brand-dark/70" : "text-gray-500"
                       )}>{testi.role}</p>
                     </div>
                  </div>
                </div>
      ...
      <section className="bg-brand-gray py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-between items-end mb-16">
            <h2 className="font-display font-medium text-4xl md:text-5xl text-brand-dark leading-tight tracking-tight">Analyse de <br/>Marché</h2>
            <Link to="/actualites" className="px-6 py-3 bg-white border border-black/10 rounded-full font-bold hover:bg-[#0a0a0a] hover:text-white transition-colors text-sm">
              Voir le Blog
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { cat: 'Marché', title: 'Comprendre la valorisation complexe en zone CEMAC', date: 'Dec 15, 2025' },
              { cat: 'Clarté', title: 'Bâtir une audience financière très précise', date: 'Dec 16, 2025' },
              { cat: 'Revenu', title: 'L\'erreur fatale de croissance pour les jeunes PME', date: 'Dec 20, 2025' },
            ].map((post, i) => (
              <div key={i} className="group cursor-pointer">
                <div className="w-full aspect-square bg-gray-200 rounded-[2rem] mb-6 overflow-hidden relative">
                   <img src={`https://images.unsplash.com/photo-1611${i}16261747-4cd1c05d6dcc?auto=format&fit=crop&q=80&w=800`} alt="Blog cover" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                   <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm px-4 py-1.5 text-xs font-bold rounded-full text-brand-dark">{post.cat}</div>
                </div>
                <h3 className="font-display font-medium text-2xl text-brand-dark mb-4 group-hover:text-brand-green transition-colors leading-tight">{post.title}</h3>
                <p className="text-sm text-gray-500 font-medium">Lars Walker • {post.date}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-brand-neon py-8 overflow-hidden border-t-8 border-[#0a0a0a]">
         <div className="flex whitespace-nowrap animate-marquee items-center">
            {[...Array(6)].map((_, i) => (
              <div key={i} className="flex items-center text-4xl md:text-5xl font-display font-bold leading-none text-[#0a0a0a]">
      ...
      <section className="bg-brand-gray py-16 px-4">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center bg-white p-12 rounded-[2rem]">
          <h3 className="font-display font-medium text-4xl text-brand-dark leading-tight mb-6 md:mb-0">
            Inscrivez-vous <br/> à notre newsletter.
          </h3>
          <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
             <input type="email" placeholder="Entrez votre email" className="px-6 py-4 bg-gray-50 border border-gray-200 rounded-xl outline-none focus:ring-2 focus:ring-brand-green/20 min-w-[300px]" />
             <button className="px-8 py-4 bg-[#0a0a0a] text-white rounded-xl font-bold transition-all hover:bg-brand-neon hover:text-[#0a0a0a]">S'inscrire</button>
          </div>
        </div>
      </section>
